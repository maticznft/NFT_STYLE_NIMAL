...
const columns = [
  ...
  const configdata = {
   ...
   function pageChange(pageData) {
     ...
     function editR(id) 
    {
        ...
        if(id!='') {
            window.location.href="/nimdaelytstfn/EditCategory/"+id;
        }
  ...
  async  function deleteR (id) {
       ...
       const {error} = await deletecategory(id);
            ...
            toast.success("Category details deleted successfully",toasterOption);
           setTimeout(
  ...
  const emptyRows = rowsPerPage - Math.min(rowsPerPage, rows.length - page * rowsPerPage);
   ...
   useEffect(() => {
    ...
    const Addcategory =async () => {
        window.location="/nimdaelytstfn/AddCategory";
    }
   ...
   const AddcategoryDet=async()=>{
    window.location="/nimdaelytstfn/AddCategorydetails";
   }
