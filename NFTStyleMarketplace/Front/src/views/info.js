...
export default function Info(props) {
  ...
  useEffect(() => {
    //console.log("innnnnnnnnnnn",nftStyle)
    Priceset()
  },[nftStyle])
                        ...
                        <div className="card-body px-0">
                          <div className="row pb-4 pt-2">
                                ...
                                ((item
                                  ...
                                  (!isEmpty(Bids.highestBid) ?
                                    (Bids && !isEmpty(Bids.highestBid) &&
                                      UserAccountAddr
                                      && UserAccountAddr != Bids.highestBid.tokenBidAddress
                                      && item
                                      && item.tokenowners_current
                                      && item.tokenowners_current.findIndex(e => e.tokenOwner == UserAccountAddr) > -1
                                      ?
                            ...
                            <div className="col-12 col-lg-6 mt-3 mt-lg-0">
                              ...
                              {
                                BuyOwnerDetailFirst
                                && BuyOwnerDetailFirst.tokenOwner != UserAccountAddr
                            ...
                            <div className="bordr_top_bot_info_div">
                              <div className="row">
                                <div className="col-12 col-lg-6">
                                  <p className="mb-0 info_card_last_txt">Service fee {Service_Fee / 1e18}%</p>
                                </div>
                               <Priceset/>
                              </div>
