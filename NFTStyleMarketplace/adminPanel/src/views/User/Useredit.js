...
export default function UserProfile(props) {
  ...
  const getUserData = async () => {
    ...
    formdata['phonenumber'] = test.userValue.phonenumber;
    formdata['address1'] = test.userValue.address1;
    formdata['address2'] = test.userValue.address2;
    formdata['pincode'] = test.userValue.pincode;
    formdata['city'] = test.userValue.city;
    formdata['country'] = test.userValue.country;
    setFormValue(formdata)
